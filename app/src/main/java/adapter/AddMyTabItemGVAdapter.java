...
import test.cc.com.demo30.MainActivity;
...
public class AddMyTabItemGVAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.txt_myitem.setBackgroundResource(position == MainActivity.DEFAULTFRAGMENT ? R.drawable.gv_selected_text_ty : R.drawable.gv_text_ty);
